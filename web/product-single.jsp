                ...
                <div class="row">
                    <c:forEach items="${requestScope.Product}" var ="p">
                        ...
                        <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                            <h3 style="color: #88ac44;">${p.name}</h3>
                            ...
                            <form action="product-single" method="POST">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p style="color: #88ac44;">Available</p>
                                    </div>
                                    <%if (a != null) {%>
                                    <input type="submit" class="btn btn-black py-3 px-5" value="Add to cart" />

                                    <%} else {%>
                                    <p><a href="login" class="btn btn-black py-3 px-5">Add to Cart</a></p>
                                    <% }%>
                                </div>
                            </form>
                        </div>
