<%-- 
    Document   : login
    Created on : May 6, 2020, 5:41:29 PM
    Author     : cauch
--%>
        ...
        <div class="container">
            <div class="container-form">
                ...
                <form action="login" method="POST">
                    ...
                    <input type="checkbox" name="memory" value="Remember account!" /> Remember account! <br>
                    <button  type="submit" class="btn btn-primary">Login</button>
                    <p></p>
                </form>
                <a href="register" style="margin-right: 20px;"  class="btn btn-primary">Register</a>  Don't have account?
            </div>
        </div>
