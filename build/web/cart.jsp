            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <div class="cart-list">
                           <a href="List" style="color: greenyellow; font-size: 50px;" >${alert}</a> 
                            <table class="table">
                                ...
                                <tbody>
                                    <c:forEach items="${sessionScope.order.items}" var="o">
                                        <tr class="text-center">
                                            <td class="product-remove"><a href="deletecart?id=${o.product.ID}" onclick="return confirm('You want to delete product?');"><span class="ion-ios-close"></span></a></td>
...
<!--                                                </div>-->
                ...
                <div class="row justify-content-end">
                    <		<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                        ...
                        <p><a href="deleteallcart" class="btn btn-primary py-4 px-3">PAY FOR PRODUCT</a></p>
                    </div>
                </div>
            </div>
        </section>
